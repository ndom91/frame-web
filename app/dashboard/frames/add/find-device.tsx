...
import { type WiFiCredentials, type FrameConfig, type SetupCommand, type PhotoFrameSetup, BLE_CONFIG } from "@/app/lib/frame-setup";
...
async function setupPhotoFrame(
  ...
  try {
    ...
    toast.success('Connected to photo frame');
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="grid gap-2">
        ...
        <Input
          ...
          onChange={(e) => {
            frameConfig.name = e.target.value
          }}
          required
        />
      </div>
      <div className="grid gap-2">
        ...
        <Input id="wifi-ssid" type="text" required onChange={(e) => {
